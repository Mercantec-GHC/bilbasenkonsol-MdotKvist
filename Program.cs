...
namespace BilbasenKonsol
{
    internal class Program
    {
        ...
        public static void DisplayVechicleFuel(string searchTerm)
        {
            int countFuel = 0;
            ...
            foreach (Car car in filteredCars)
            {
                ...
                {
                    Console.WriteLine($"Brand: {car.Brand}, Model: {car.Model}, Year: {car.Year}, Color: {car.Color}, HorsePower: {car.HoursePower}, Cylinders: {car.NumberOfCylinders}, Fuel Type: {car.FuelType}");
                    countFuel++;
                }
            }
            Console.WriteLine($"Total search result: {countFuel}");
